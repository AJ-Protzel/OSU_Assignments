# We are going to cheat a little here and use a package for the dataset and decision trees. 
# Thats why this isn't considered an implementation question.
...
for m in range(M):
  ...
  ###################################################
  # indexes = np.random.choice(len(y_train), size=len(y_train), replace=True)

  # X_training = []
  # y_training = []
  # for i in indexes:
  #   X_training.append(X_train[i])
  ...
  clf = tree.DecisionTreeClassifier(criterion="entropy", max_features=9) # line 44
